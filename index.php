...
<body>
    ...
    <div class="container profile_container">
      ...
      <div class="plofile_main-box">
        ...
        <p class="profile_text">大阪出身・宮城在住の27歳。<br>
          本名は中島三希子なのですが、LGBTで女の子の名前が好きではなくてよく海(かい)と呼ばれています。<br>
  ...
  <section class="contact" id="contact">
    <div class="contact-container">
      <p class="works_text">お問い合わせ</p>
      <h1 class="works_title">Contact</h1>
      <?php if ($err_msg != '') : ?>
        <div class="alert alert-danger">
          <?php echo $err_msg; ?>
        </div>
      <?php endif; ?>
      <form class="contact_form" action="thanks.php" method="post" enctype="multipart/form-data">
        <div class="contact_form-name">
          <label class="contact_form-name-label" for="name">お名前</label>
          <input class="contact_form-name-text" type="text" name="name" id="name" placeholder="お名前" value="<?php echo $name; ?>">
        </div>
        <div class="contact_form-mail">
          <label class="contact_form-mail-label" for="mail">メールアドレス</label>
          <input class="contact_form-mail-text" type="email" name="mail" id="mail" placeholder="メールアドレス" value="<?php echo $email; ?>">
        </div>
        <div class="contact_form-message">
          <label class="contact_form-message-label" for="message">お問い合わせ内容</label>
          <textarea class="contact_form-message-text" name="message" id="message" cols="30" rows="10" placeholder="お問い合わせ内容"><?php echo $message; ?></textarea>
        </div>
        <div class="contact_form-btn-box">
          <input class="contact_form-btn" type="submit" value="送信">
        </div>
      </form>
    </div>
  </section>
